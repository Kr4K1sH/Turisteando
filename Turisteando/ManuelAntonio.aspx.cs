...
{
    public partial class ManuelAntonio : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if ((o.Lugar.ToString().Equals("manuel antonio")))
                {
                    if (o.nombre.ToString().Equals("manuel antonio"))
                    {
                    ...
                    if (o.nombre.ToString().Equals("scuba"))
                    {
