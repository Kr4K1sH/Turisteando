<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManuelAntonio.aspx.cs" Inherits="Turisteando.ManuelAntonio" %>
...
<body style="background-color:#212f3d;" >
    ...
    <form id="form1" runat="server">
   					...
   					<!--Barra de Navegación-->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="font-family: 'Times New Roman',serif; width: 100%; height: 50%;">
...
<li><a href='#'	><img src='./imagenestodas/imagenes/4.jpg' alt=''  width="500" height="500"/></a></li>
     ...
     <div class="row">
              ...
              <div class="col-sm-5"  >
                  <h1 class="mb-0" style=" color:antiquewhite; text-align:center;">
