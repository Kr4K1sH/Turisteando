...
{
    public partial class jaco : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (i.lugar.ToString().Equals("jaco"))
                {
            ...
            {
                if ((o.Lugar.ToString().Equals("jaco")))
                {
                    if (o.nombre.ToString().Equals("playa jaco"))
                    {
                        this.Image1.ImageUrl = o.URL(o.img);

                    }
                    if (o.nombre.ToString().Equals("atardecer"))
                    {
                        this.Image2.ImageUrl = o.URL(o.img);
                    }
                    if (o.nombre.ToString().Equals("jaco"))
                    {
