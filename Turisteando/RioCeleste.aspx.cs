...
{
    public partial class RioCeleste : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (i.lugar.ToString().Equals("Rio Celeste"))
                {
            ...
            {
                if ((o.Lugar.ToString().Equals("Rio Celeste")))
                {
                    if (o.nombre.ToString().Equals("celeste"))
                    {
                        this.Image1.ImageUrl = o.URL(o.img);

                    }
                    if (o.nombre.ToString().Equals("rio celeste"))
                    {
                        this.Image2.ImageUrl = o.URL(o.img);
                    }
                    if (o.nombre.ToString().Equals("rio celeste catarata"))
                    {
